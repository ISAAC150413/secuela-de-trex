...
background(180)
 ...
 spawnObstacles();
  ...
  text ("LA AVENTURA DE TREX PARTE 2",200, 20)
  text ("ESPERO LO DISFRUTES",20,20)
  text ("Estos son tus",500,40)
  text ("puntos,aprendelos",500,50)
  text (" muere en el cactus para sonido",200,60)
